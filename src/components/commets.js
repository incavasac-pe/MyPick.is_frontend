          ...
          {comentarios.map((comentario) => (
            <div className="box-comentario" key={comentario.id}>
              <div className="content">
                ...
                {comentario?.foto ? (
                      <img src={updateImageUrl(comentario?.foto)} alt="user" />
                    ) : (
                      <img src="https://mypick.is/descarga.png" alt="user" />
                    )}
                </div>
                  ...
                  <div className="content-footer">
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        handleButtonClick("CommentReply");
                      }}
                    >
                      ...
                      <div className="mt-3 mb-3">
                        {comentario.respuestas.map((respuesta) => (
                          <div key={respuesta.id} className="respuesta">
                            <div className="avatar">
                              <img
                                src={`${API_BASE_URL}/see_photo?img=${respuesta.foto}`}
                                alt="user"
                              />
                            </div>
                            <div className="content-comment">
                  ...
                  {mostrarFormularioRespuesta[comentario.id] && (
                    <div className="nueva-respuesta">
                      ...
                      <div className="text-right mt-3 mb-3">
                        ...
                        <button
                          className="login"
                          onClick={() => this.agregarRespuesta(comentario.id)}
                        >
                          Reply
                        </button>
                      </div>
